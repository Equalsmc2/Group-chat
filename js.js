...
const THEMES = {
    ...
    'Magnus': { color: '#ffee00', glow: 'rgba(255, 238, 0, 0.4)', avatar: '💀' },  
    'Asya': { color: '#00e5ff', glow: 'rgba(0, 229, 255, 0.4)', avatar: '📻' },  
    'Alexandria': { color: '#9d00ff', glow: 'rgba(157, 0, 255, 0.4)', avatar: '👑' },  
    'Fitz': { color: '#00ff66', glow: 'rgba(0, 255, 102, 0.4)', avatar: '⚗️' }   
};
...
function appendMessage(msg, isNew = false) {
    ...
    // Smoothly glides to the newest message
